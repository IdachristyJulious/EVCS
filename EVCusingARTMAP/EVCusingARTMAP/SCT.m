function [S1,S2]=SCT(newNetsct)
Img=imread('C:\Users\NEW\Documents\MATLAB\work\EVCusingARTMAP\EXTIMG1.tiff');
[m,n]=size(Img);
n=n/3;
k=1;
for i=1:m
    ...
    for j=1:n
        ...
        ccNewInput = ART_Complement_Code(img);
        class = ARTMAP_Classify(newNetsct, ccNewInput);
        switch(class)
            case 1
                S2(k,l,:)=[255,255,0];
                S2(k,l+1,:)=[0,255,255];
